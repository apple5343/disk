...
Тестовый пример доступен в виде [postman коллекции](./docs/disk_example_collection.json). Приведены примера регистрации, входа, загрузки и скачивания файла. В коллекции созданы variables. Для запуска нужно импортировать коллекцию в Postman. При загрузки файла необходимо выбрать локальный файл.
